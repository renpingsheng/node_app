    ...
    <div class="fillcontain">
        ...
        <div class="table_container">
            <el-table max-height="450" border v-if="tableData.length > 0" :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="describe" label="收支描述" align='center' width="120">
                </el-table-column>
                ...
                <el-table-column prop="expend" label="支出" align='center' width="80">
                    <template slot-scope="scope">
                        <span style="color:#f56767">- {{ scope.row.expend }}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="cash" label="账户现金" align='center' width="80">
                    <template slot-scope="scope">
